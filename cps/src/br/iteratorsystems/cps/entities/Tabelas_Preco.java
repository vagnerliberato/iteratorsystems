...
public class Tabelas_Preco  implements java.io.Serializable, EntityAble {


	 private static final long serialVersionUID = -162626912854446730L;
	 private Tabelas_PrecoId id;
     private Tabelas_Produto produto;
     private String precoVarejo;

    public Tabelas_Preco() {
    }

    public Tabelas_Preco(Tabelas_PrecoId id, Tabelas_Produto produto, String precoVarejo) {
       this.id = id;
    ...
    public Tabelas_PrecoId getId() {
        return this.id;
    }
    
    public void setId(Tabelas_PrecoId id) {
        this.id = id;
    }
@ManyToOne(fetch=FetchType.EAGER)
    ...
    public Tabelas_Produto getProduto() {
        return this.produto;
    }
    
    public void setProduto(Tabelas_Produto produto) {
        this.produto = produto;
    }
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof Tabelas_Preco))
			return false;
		Tabelas_Preco other = (Tabelas_Preco) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String toString() {
		return "Tabelas_Preco [id=" + id + ", precoVarejo=" + precoVarejo
				+ ", produto=" + produto + "]";
	}
