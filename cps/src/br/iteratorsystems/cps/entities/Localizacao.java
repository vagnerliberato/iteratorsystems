 ...
 */
@Entity
@Table(name = "localizacao", schema = "tabelas")
public class Localizacao implements java.io.Serializable,EntityAble {
	...
	public Localizacao(BigInteger id, String country, String language,
			String iso2, String region1, String region2, String region3,
			String region4, String zip, String city, String area1,
			String area2, Double lat, Double lng, String tz, String utc,
			String dst) {
		this.id = id;
	...
	@Column(name = "iso2", nullable = true, length = 6)
	...
	@Column(name = "region2", nullable = true, length = 60)
	...
	@Column(name = "region3", nullable = true, length = 60)
	...
	@Column(name = "region4", nullable = true, length = 60)
	...
	@Column(name = "area2", nullable = true, length = 80)
	...
	@Column(name = "tz", nullable = true, length = 30)
	public String getTz() {
		return this.tz;
	}
	...
	@Column(name = "utc", nullable = true, length = 10)
	...
	@Column(name = "dst", nullable = true, length = 1)
