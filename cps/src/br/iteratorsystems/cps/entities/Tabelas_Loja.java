...
/**
 * Tabelas_Loja generated by hbm2java
 */
@Entity
@Table(name = "loja", schema = "tabelas")
public class Tabelas_Loja implements java.io.Serializable, EntityAble {

	private static final long serialVersionUID = 1L;
	private Tabelas_LojaId id;
	private Tabelas_Rede rede;
	...
	public Tabelas_Loja(Tabelas_LojaId id, Tabelas_Rede rede, String razaosocial, String nomefantasia,
	...
	public Tabelas_LojaId getId() {
		return this.id;
	}

	public void setId(Tabelas_LojaId id) {
		this.id = id;
	}

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "id_rede", nullable = false, insertable = false, updatable = false)
	public Tabelas_Rede getRede() {
		return this.rede;
	}

	public void setRede(Tabelas_Rede rede) {
		this.rede = rede;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof Tabelas_Loja))
			return false;
		Tabelas_Loja other = (Tabelas_Loja) obj;
		if (bairro == null) {
	...
	public String toString() {
		return "Tabelas_Loja [bairro=" + bairro + ", cep=" + cep + ", cidade=" + cidade
