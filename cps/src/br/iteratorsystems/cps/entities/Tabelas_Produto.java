...
public class Tabelas_Produto implements java.io.Serializable, EntityAble {

	 private static final long serialVersionUID = 2396720478904300397L;
	 
	 private Tabelas_ProdutoId id;
     private Tabelas_Loja loja;
     private String descricao;
     private String unidadeMedida;
     private String embalagem;
     private char status;
     private Set<Tabelas_Preco> precos = new HashSet<Tabelas_Preco>(0);

    public Tabelas_Produto() {
    }

	
    public Tabelas_Produto(Tabelas_ProdutoId id, Tabelas_Loja loja, String descricao, char status) {
        this.id = id;
        this.loja = loja;
        this.descricao = descricao;
        this.status = status;
    }
    public Tabelas_Produto(Tabelas_ProdutoId id, Tabelas_Loja loja, String descricao, String unidadeMedida, String embalagem, char status, Set<Tabelas_Preco> precos) {
       this.id = id;
       this.loja = loja;
       this.descricao = descricao;
    ...
    public Tabelas_ProdutoId getId() {
        return this.id;
    }
    
    public void setId(Tabelas_ProdutoId id) {
        this.id = id;
    }
@ManyToOne(fetch=FetchType.EAGER)
    ...
    public Tabelas_Loja getLoja() {
        return this.loja;
    }
    
    public void setLoja(Tabelas_Loja loja) {
        this.loja = loja;
    }
...
@OneToMany(cascade=CascadeType.ALL, fetch=FetchType.LAZY, mappedBy="produto")
    public Set<Tabelas_Preco> getPrecos() {
        return this.precos;
    }
    
    public void setPrecos(Set<Tabelas_Preco> precos) {
        this.precos = precos;
    }
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof Tabelas_Produto)) {
			return false;
		}
		Tabelas_Produto other = (Tabelas_Produto) obj;
		if (descricao == null) {
	...
	public String toString() {
		return "Tabelas_Produto [descricao=" + descricao + ", embalagem=" + embalagem
