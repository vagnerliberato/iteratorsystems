 ...
 */
@Embeddable
public class Tabelas_LojaId  implements java.io.Serializable,EntityAble {
    ...
    public Tabelas_LojaId() {
    }

    public Tabelas_LojaId(Integer idLoja, Integer idRede) {
       this.id = idLoja;
       this.idRede = idRede;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Tabelas_LojaId) ) return false;
		 Tabelas_LojaId castOther = ( Tabelas_LojaId ) other; 
...
public String toString() {
	return "Tabelas_LojaId [idLoja=" + id + ", idRede=" + idRede + "]";
}  
