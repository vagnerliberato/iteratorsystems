...
(
	...
	ID_LOJA INT NOT NULL,
	CODIGO_BARRAS CHAR (20) NOT NULL,
	PRECO_ATACADO DOUBLE NOT NULL DEFAULT (0),-- SE NÃO TIVER NENHUM PREÇO O PADRÃO SERÁ R$ 0
	PRECO_VAREJO DOUBLE NOT NULL DEFAULT (0),-- SE NÃO TIVER NENHUM PREÇO O PADRÃO SERÁ R$ 0
	PRECO_PROMOCAO DOUBLE NOT NULL DEFAULT (0),-- SE NÃO TIVER NENHUM PREÇO O PADRÃO SERÁ R$ 0 
	DATAULTIMAMODIFICACAO DATE NOT NULL DEFAULT (CURRENT_DATE),
...
CREATE INDEX IDX_TABELASLOJANOMEFANTASIA
  ON TABELAS.LOJA
  USING BTREE
  (NOMEFANTASIA);
...
ALTER TABLE TABELAS.LOGIN OWNER TO POSTGRES;

CREATE INDEX IDX_TABELASLOGIN
  ON TABELAS.LOGIN
  USING BTREE
  (NOME_LOGIN);
...
ALTER TABLE TABELAS.LISTA_PRODUTO_ITEM OWNER TO POSTGRES;

CREATE INDEX IDX_TABELASLISTA_PRODUTO_ITEM
  ON TABELAS.LISTA_PRODUTO_ITEM
  USING BTREE
  (CODIGO_BARRAS);
